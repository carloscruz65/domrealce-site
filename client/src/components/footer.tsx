...
import logoDomrealce from "@/assets/domrealce-logo.png"; // ✅ AGORA VEM DOS ASSETS

export default function Footer() {
  return (
    <footer
      id="contactos"
      className="bg-black border-t border-brand-turquoise py-16"
    >
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-brand-blue pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} DOMREALCE. Todos os direitos
            reservados.
          </p>
