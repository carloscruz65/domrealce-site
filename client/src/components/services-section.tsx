...
const services = [
  ...
  },
  {
    ...
    description:
      "Em vinil, lona, canvas e papel de parede com alta definição e cores vibrantes",
  ...
  },
  {
    ...
    description:
      "Sinalização interior e exterior profissional para o seu negócio",
  ...
  },
  {
    ...
    description:
      "Reduzem o calor, protegem dos raios UV e proporcionam privacidade mantendo a luminosidade natural",
  ...
  },
  {
    ...
    description:
      "Destacamo-nos em decoração de camiões, máquinas de obras e viaturas de competição",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            Soluções completas em comunicação visual para destacar sua marca no
            mercado
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Link to={service.link} key={service.link}>
